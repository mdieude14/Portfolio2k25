...
export const Bio = {
  ...
  roles: [
    ...
    "développeur mobile",
    "développeur 3D junior",
    "UI/UX Designer",
  ],
  description:
    "Je suis un étudiant motivé, assidu et à l'écoute des autres. De nature souriant, je suis autonome tout en appréciant le travail en équipe, la communication et la capitalisation des idées projet. toujours prêt à relever de nouveaux défis.",
  linkedin: "https://www.linkedin.com/in/martin-dieude-0312bb44/",
};
...
export const experiences = [
  {
    ...
    company: "Terrians (Start-up IOT Valley)",
    date: "Avril 2024 - juin 2024",
    desc: " Stage: Mettre en place un système permettant de traduire automatiquement tous les éléments de type Texte présents sur un site internet, selon la langue définie par l'utilisateur",
    skills: [
     "Vue3js"
    ],
    doc: "https://www.terrians.com/",
  },
  {
    id: 1,
    img: victoria,
    role: "Serveur/Runner",
    company: "Victoria, Bistro Regent,",
    date: "septembre 2023 - janvier 2024",
    desc: "Experiences: Serveur et runner",
    skills: [
     "Serveur",
     "Runner",
     ...
     "Accueil des clients",
     "Service à la table",
     "Nettoyage des tables, Mise en place des tables",
  ...
  },
  {
    ...
    company: "Mairie de Castres",
    date: "juin 2024 - août 2024",
    desc: "Animateur centre de loisirs tranche d'age 10-14",
    skills: [
    "gestion et Organisation des activités",
    "responsabilité dans la supervision des enfants et de leur sécurité",
    "gestion des ressources",
    "gestion des événements inter centre de loisirs",
    "gestion des relations avec les parents",
    "gestion du budget pour le planning des activités",
    "Organisation et responsabilité des sorties hors centre",
    "gestion du stress",
  ...
  },
  {
    ...
    desc: "Animateur centre de loisirs tranche d'age 7-10",
    skills: [
    "gestion et Organisation des activités",
    "responsabilité dans la supervision des enfants et de leur sécurité",
    "gestion des ressources",
  ...
  },
  {
    ...
    desc: "Animateur centre de loisirs tranche d'age 6-7",
    skills: [
    "gestion et Organisation des activités",
    "responsabilité dans la supervision des enfants et de leur sécurité",
    "gestion des ressources",
  ...
  },
  {
    id: 5,
    img: region,
    role: "Correspondant d'établissement",
    company: "Region Occitanie",
    date: "juin 2022 - août 2022",
    desc: "Correspondant d'établissement pour la région Occitanie dans les établissements scolaires du tarn",
    skills: [
      "gestion du stock des Manuels et equipements pédagogiques par classes et filières dans chaque établissement scolaire",
      "distribution des manuels et equipements pédagogiques par classes et filières dans chaque établissement scolaire",
      "inventaire des manuels et equipements pédagogiques distribués par établissement scolaire",
      "classification des manuels distribués à chaque éleves par établissement scolaire sur la plateforme de gestion de la région occitanie",
  ...
  },
  {
    ...
    company: "Freshcore",
    date: "decembre 2020 - janvier 2021",
    desc: " aide au développement d'un application support pour leur equipe ",
    skills: [
      "HTML",
      "CSS",
      "JavaScript",
  ...
  },
  {
    id: 7,
    img: startPeople,
    role: "Mission interimaire",
    company: "Start People",
    date: "2020 - 2024",
    desc: "Mission interimaire sur differents secteurs d'activités",
    skills: [
      "Capacité d'adaptation",
      "gestion du stress",
      "implication et proactivité",
      "travail en équipe",
...
export const education = [
  {
    ...
    date: "Oct 2024 - 2025",
    grade: "Bachelor 3 concepteur-développeur d'applications",
    desc: "Formation concepteur-développeur d'applications en alternance Malheuresement interrompue par manque d'entreprise",
    degree: "Bachelor 3 concepteur-développeur d'applications",
  },
  {
    id: 1,
    img: ynov,
  ...
  },
  {
    ...
    school: "BGE",
    date: "Mars 2023",
    grade: "Bachelor 2 développeur web et web mobile",
    desc: "Obtention du Titre professionnel de développeur web et web mobile",
    degree: "Bachelor 2 développeur web et web mobile",
  },
  {
    id: 4,
    img: BGE,
    ...
    grade: "Bachelor 2 développeur web et web mobile",
    desc: "Formation de Développeur Web et mobile à BGE sud-ouest(Toulouse)",
    degree: "Bachelor 2 développeur web et web mobile",
  },
  {
    id: 5,
    ...
    date: "decembre 2020 - janvier 2021",
    grade: "Formation en autodidacte via Openclassrooms et autres ressources",
    desc: " Apprendre les bases du développement web et mobile de maniere autonome via des cours et des exercices open sources",
    degree: "Formation en autodidacte via Openclassrooms et autres ressources",
  },
  {
    id: 6,
    img: bordeBasse,
    school: "Lycées Borde Basse",
    date: " juin 2020",
    grade: "Obtention du BAC STI2D",
